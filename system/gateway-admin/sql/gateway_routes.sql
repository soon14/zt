...
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8 COMMENT='路由表';

-- ----------------------------
-- Records of gateway_routes
-- ----------------------------
INSERT INTO `gateway_routes` VALUES ('26', '16', 'lb://schedule-admin', '[{\"name\":\"Path\",\"args\":{\"pattern\":\"/schedule/**\"}}]', '[]', '0', null, 'Y', '2019-04-03 15:39:40', '2019-04-03 15:43:53', 'system', 'system');
