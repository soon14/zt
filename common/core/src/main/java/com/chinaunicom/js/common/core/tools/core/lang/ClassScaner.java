package com.chinaunicom.js.common.core.tools.core.lang;
...
import com.chinaunicom.js.common.core.tools.core.collection.EnumerationIter;
...
public class ClassScaner {
	...
	private void addIfAccept(String className) {
		...
		if(classLen == packageLen) {
			...
			//检查类名是否以指定包名为前缀，包名后加.（避免类似于com.chinaunicom.js.common.core.tools.A和com.chinaunicom.js.common.core.tools.ATest这类类名引起的歧义）
