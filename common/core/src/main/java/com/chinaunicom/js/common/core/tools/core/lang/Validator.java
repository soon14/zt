...
import com.chinaunicom.js.common.core.tools.core.exceptions.ValidateException;
...
public class Validator {
	...
	public static boolean isLetter(CharSequence value) {
		return StrUtil.isAllCharMatch(value, new com.chinaunicom.js.common.core.tools.core.lang.Matcher<Character>() {
			@Override
