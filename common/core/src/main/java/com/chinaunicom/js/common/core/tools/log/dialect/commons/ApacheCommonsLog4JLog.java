package com.chinaunicom.js.common.core.tools.log.dialect.commons;
...
import com.chinaunicom.js.common.core.tools.log.AbstractLocationAwareLog;
...
public class ApacheCommonsLog4JLog extends AbstractLocationAwareLog {
	...
	@Override
	public void log(String fqcn, com.chinaunicom.js.common.core.tools.log.level.Level level, Throwable t, String format, Object... arguments) {
		Level log4jLevel;
		switch (level) {
			case TRACE:
