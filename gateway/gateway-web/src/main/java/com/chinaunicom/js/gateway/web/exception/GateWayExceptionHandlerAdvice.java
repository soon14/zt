package com.chinaunicom.js.gateway.web.exception;
...
public class GateWayExceptionHandlerAdvice {
    ...
    public Result handle(ResponseStatusException ex) {
        LoggerHelp.error("response status exception:{}", ex.getMessage());
        return Result.fail(ErrorType.GATEWAY_ERROR);
    }

    @ExceptionHandler(value = {ConnectTimeoutException.class})
    public Result handle(ConnectTimeoutException ex) {
        LoggerHelp.error("connect timeout exception:{}", ex.getMessage());
    ...
    public Result handle(NotFoundException ex) {
        LoggerHelp.error("not found exception:{}", ex.getMessage());
    ...
    public Result handle(RuntimeException ex) {
        LoggerHelp.error("runtime exception:{}", ex.getMessage());
        return Result.fail();
    }
    ...
    public Result handle(Exception ex) {
        LoggerHelp.error("exception:{}", ex.getMessage());
        return Result.fail();
    }
